...
insert ignore into recommendations VALUES  (101, 'Clothing', 'Wear coat and bring umbrella'),
                                           ...
                                           (204, 'Activity', 'Outdoor exercises are not recommended, which will breathe in too much harmful substances. It''s bettter to do indoor exercises like yoga, swimming or go to the gym. '),
                                           (304, 'Plant', 'Haze affects the exposure of sunlight and thus the photosynthesis of plants. Apply proper fertilizer and keep plants warm to provide sufficient nutrients for the plants'),
...
insert ignore into weather_codes (code, text) VALUES(200, 'Thunderstorm'),
                                                    (201, 'Thunderstorm'),
                                                    (202,	'Thunderstorm'),
                                                    (210, 'Thunderstorm'),
                                                    (211, 'Thunderstorm'),
...
insert ignore into weather_reco_mappings VALUES  (200, 101),
                                                 (200, 201),
                                                 (200, 301),
                                                 (201, 101),
                                                 (201, 201),
